                ...
                <!--  PRODUCT CATEGORY TITLE -->
                    ...
                    <div class="form-group">  <!--- form-group starts --->
                        ...
                        <div class="col-md-6"> <!--- col-md-6 starts --->
                          ...
                          <input value="Update Payment Status" name="submit" type="submit" class="form-control btn btn-primary">
...
<?php  
    ...
    if(isset($_POST['submit'])){
        ...
        $update_payment_status = "update payment set payment_status='$payment_status' where payment_id='$payment_id'";
              
        $run_payment_status = mysqli_query($con,$update_payment_status);
              
        if($run_payment_status){
                  
            echo "<script>alert('Payment Status has been Successfully updated into Database!')</script>";
