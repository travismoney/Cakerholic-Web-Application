                ...
                <!--  PRODUCT CATEGORY TITLE -->
                    ...
                    <div class="form-group">  <!--- form-group starts --->
                        ...
                        <div class="col-md-6"> <!--- col-md-6 starts --->
                            ...
                            <input value="<?php echo $product_category_name; ?>" name="product_category_name" type="text" class="form-control">
                ...
                <!--  PRODUCT CATEGORY DESCRIPTION -->
                    ...
                    <div class="form-group">  <!--- form-group starts --->
                        ...
                        <div class="col-md-6"> <!--- col-md-6 starts --->
                            ...
                            <textarea type="text" name="product_category_description" id="" cols="30" rows="10" class="form-control"><?php echo $product_category_description; ?></textarea>
...
<?php  
    ...
    if(isset($_POST['submit'])){
        ...
        $update_product_category = "update product_category set product_category_name='$product_category_name',product_category_description='$product_category_description' where product_category_id='$product_category_id'";
