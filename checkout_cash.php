                		...
                		<div class="billing_form_area">
                			<form action="" class="billing_form row" method="post" id="contactForm"  enctype="multipart/form-data">
				                ...
				                <!-- collection_date -->
									...
									<input type="date" class="form-control" id="collection_date"  placeholder="Select an option" name="delivery_date" required>
								</div>
				                <div class="form-group col-md-6">
				                <!-- collection_time  -->
                		...
                		<div class="order_box_price">
							...
							<div class="payment_list">
							 ...
							 <?php
		                        ...
		                        <h4 style="text-align: center; margin-top: 20px;">Cash On Delivery</h4>
		                        <img style="display: block; margin-left: auto; margin-right: auto; width: 300px; height: 120px; padding-top: 20px;" src="./img/cash-on-delivery.png" alt="">
							</div>
						</div>
                	</div>
                </div>
...
if(isset($_POST['action'])){
   ...
   while($row_products = mysqli_fetch_array($run_products)){
    ...
    // inserting into order confirmation
